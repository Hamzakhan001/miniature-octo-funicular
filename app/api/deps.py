...
from app.services.ingestion_queue import LocalIngestionQueue
...
@lru_cache
def get_ingestion_queue() -> LocalIngestionQueue:
    return LocalIngestionQueue(ingestion_service=get_ingestion_service())
